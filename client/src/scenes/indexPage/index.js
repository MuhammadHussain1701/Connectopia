        ...
        >
          <div class="main-article__content">
            ...
            <p class="main-article__paragraph">
              ...
              building genuine connections, fostering friendships, and creating
              a community where everyone feels valued. Our platform is designed
              to empower you to express yourself, connect with like-minded
              individuals, and engage in enriching conversations. With a
              user-friendly interface and a myriad of exciting features,
              Connectopia offers a refreshing and inclusive social media
              experience. Whether you're a seasoned social media enthusiast or
              new to the digital landscape, our platform caters to individuals
              of all backgrounds, ages, and interests.
            </p>
            
            <NavLink className="index-btn" to="/login">Get into Connectopia</NavLink>
